...
restaurantes = [{'nome':'Burguer King', 'categoria':'Hambúrguer', 'ativo':False},
                {'nome':'Pizza Hut','categoria':'Pizza', 'ativo':True},
                {'nome':'Subway','categoria':'Sanduíche', 'ativo':False}]
...
def cadastrar_novo_restaurante():
    '''Função é responsavel por cadastrar novo restaurante
    Inputs:
    -Nome do restaurante
    -Categoria
    Output:
    -Adiciona restaurante a lista de restaurantes
    '''
